...
class Exp_stock(Exp_Basic):
    ...
    def train(self, setting):
        ...
        np.save(f"./conv_weights/low_weights_histor_{self.args.data}.npy", np.stack(low_weights_history))  # 形状 [num_epochs, 7, 1, 8]
        np.save(f"./conv_weights/high_weights_history_{self.args.data}.npy", np.stack(high_weights_history))
