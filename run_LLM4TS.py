...
parser.add_argument('--llm', type=str, default='gpt2', help='the llm checkpoint')
...
parser.add_argument('--segment_csv_path', type=str, default='./segments/sisc_hs300_k12_l8-16_dba_kmpp_segmentation.csv', help='segment_csv_path')
...
if __name__ == '__main__':
    ...
    test_dt = pd.read_csv(f'./dataset/{data_name}_dt.csv')
    df = pd.read_csv(f'./dataset/{data_name}_org.csv')
    ...
    if args.is_training:
        for ii in range(args.itr):
            ...
            if args.use_multi_gpu and args.use_gpu and args.local_rank != 0:
                ...
                com_df.columns = cols
                com_df.to_csv(f'./{data_name}_data/hold_{data_name}_{ii}_{args.dynamic_segment}_{args.wavelet}_{args.llm_layers}_pt.csv', index=False)
                ...
                output_df.to_csv(f'./{data_name}_data/return_{data_name}_{ii}_{args.dynamic_segment}_{args.wavelet}_{args.llm_layers}_pt.csv', index=False)
