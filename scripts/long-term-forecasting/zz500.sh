...
do
    ...
    --wavelet $wavelet\
    --wavename $wavename\
    --segment_csv_path ./segments/sisc_$data_name'_k12_l8-16_dba_kmpp_segmentation.csv'\
    --checkpoints ./checkpoints/long-term-forecasting/$data_name \
    > ./logs/long-term-forecasting/$data_name/$model_id'_31_8_16_'$pred_len'_llml'$llm_layers'_lr'$lr'_bs'$bs'_'$exp_des'_dseg'$dynamic_segment'_wave'$wavelet'_tensor'.log 2>&1 
done
done
done
done
