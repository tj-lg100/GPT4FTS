2018-01-02export CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7
...
if [ ! -d "/mnt/petrelfs/chengdawei/lustre/aLLM4TS/logs/pt_patch/pt_data" ]; then
    mkdir /mnt/petrelfs/chengdawei/lustre/aLLM4TS/logs/pt_patch/pt_data
fi

if [ ! -d "/mnt/petrelfs/chengdawei/lustre/aLLM4TS/checkpoints/pt_patch/pt_data" ]; then
    mkdir /mnt/petrelfs/chengdawei/lustre/aLLM4TS/checkpoints/pt_patch/pt_data
fi
